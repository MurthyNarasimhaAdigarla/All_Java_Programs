...
public class SecondLargest {
	...
	public static void main(String[] args) {
		System.out.println(secondLargest(new int[] { 1, 2, 3, 4, 5, 6, }));

		/*
		 * System.out.println(secondLargest(new int[] { 985, 521, 975, 831, 479, 861
		 * }));
		 * 
		 * System.out.println(secondLargest(new int[] { 9459, 9575, 5692, 1305, 1942,
		 * 9012 }));
		 * 
		 * System.out.println(secondLargest(new int[] { 47498, 14526, 74562, 42681,
		 * 75283, 45796 }));
		 */
	}
